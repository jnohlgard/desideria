...
target_link_options(deri_bsp_flags INTERFACE ${CPU_C_FLAGS} -T "${DERI_ARCH_BASEDIR}/riscv/ld/sifive_e.lds")
target_link_directories(deri_bsp_flags INTERFACE "${DERI_ARCH_BASEDIR}/${ARCH}/ld" "${DERI_ARCH_BASEDIR}/common/ld")
