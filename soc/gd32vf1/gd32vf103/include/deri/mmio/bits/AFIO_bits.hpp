...
enum class AFIO_regs::EC_bits : uint32_t {
  EOE = (1 << 7),             ///< Event output enable
  PORT_mask = (0x7 << 4),     ///< Event output port selection
  PIN_mask = (0xf << 0),      ///< Event output pin selection
...
enum class AFIO_regs::PCF0_bits : uint32_t {
  TIMER1ITI1_REMAP = (1 << 29),   ///< TIMER1 internal trigger 1 remapping
  SPI2_REMAP = (1 << 28),         ///< SPI2/I2S2 remapping
  SWJ_CFG_mask = (0x7 << 24),     ///< Serial wire JTAG configuration
  CAN1_REMAP = (1 << 22),         ///< CAN1 I/O remapping
  TIMER4CH3_IREMAP = (1 << 16),   ///< TIMER4 channel3 internal remapping
  PD01_REMAP = (1 << 15),         ///< Port D0/Port D1 mapping on OSC_IN/OSC_OUT
  CAN0_REMAP_mask = (0x3 << 13),  ///< CAN0 alternate interface remapping
  TIMER3_REMAP = (1 << 12),       ///< TIMER3 remapping
  TIMER2_REMAP_mask = (0x3 << 10),  ///< TIMER2 remapping
  TIMER1_REMAP_mask = (0x3 << 8),   ///< TIMER1 remapping
  TIMER0_REMAP_mask = (0x3 << 6),   ///< TIMER0 remapping
  USART2_REMAP_mask = (0x3 << 4),   ///< USART2 remapping
  USART1_REMAP = (1 << 3),          ///< USART1 remapping
  USART0_REMAP = (1 << 2),          ///< USART0 remapping
  I2C0_REMAP = (1 << 1),            ///< I2C0 remapping
  SPI0_REMAP = (1 << 0),            ///< SPI0 remapping
...
enum class AFIO_regs::EXTISS0_bits : uint32_t {
  EXTI3_SS_mask = (0xf << 12),  ///< EXTI 3 sources selection
  EXTI2_SS_mask = (0xf << 8),   ///< EXTI 2 sources selection
  EXTI1_SS_mask = (0xf << 4),   ///< EXTI 1 sources selection
  EXTI0_SS_mask = (0xf << 0),   ///< EXTI 0 sources selection
...
enum class AFIO_regs::EXTISS1_bits : uint32_t {
  EXTI7_SS_mask = (0xf << 12),  ///< EXTI 7 sources selection
  EXTI6_SS_mask = (0xf << 8),   ///< EXTI 6 sources selection
  EXTI5_SS_mask = (0xf << 4),   ///< EXTI 5 sources selection
  EXTI4_SS_mask = (0xf << 0),   ///< EXTI 4 sources selection
  Reserved_mask = 0xffff0000    ///< All reserved bits
};
...
enum class AFIO_regs::EXTISS2_bits : uint32_t {
  EXTI11_SS_mask = (0xf << 12),  ///< EXTI 11 sources selection
  EXTI10_SS_mask = (0xf << 8),   ///< EXTI 10 sources selection
  EXTI9_SS_mask = (0xf << 4),    ///< EXTI 9 sources selection
  EXTI8_SS_mask = (0xf << 0),    ///< EXTI 8 sources selection
  Reserved_mask = 0xffff0000     ///< All reserved bits
};
...
enum class AFIO_regs::EXTISS3_bits : uint32_t {
  EXTI15_SS_mask = (0xf << 12),  ///< EXTI 15 sources selection
  EXTI14_SS_mask = (0xf << 8),   ///< EXTI 14 sources selection
  EXTI13_SS_mask = (0xf << 4),   ///< EXTI 13 sources selection
  EXTI12_SS_mask = (0xf << 0),   ///< EXTI 12 sources selection
  Reserved_mask = 0xffff0000     ///< All reserved bits
};
...
enum class AFIO_regs::PCF1_bits : uint32_t {
  EXMC_NADV = (1 << 10),      ///< EXMC_NADV connect/disconnect
