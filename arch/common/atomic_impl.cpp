...
[[gnu::used]] uint64_t __atomic_load_8(volatile const void *ptr, int memorder) {
  return deri::atomic_load<uint64_t>(ptr, memorder);
}
[[gnu::used]] void __atomic_store_8(volatile void *ptr,
                                    uint64_t val,
                                    int memorder) {
  deri::atomic_store(ptr, val, memorder);
}
[[gnu::used]] uint64_t __atomic_exchange_8(volatile void *ptr,
                                           uint64_t val,
                                           int memorder) {
  return deri::atomic_fetch_op(
      ptr, val, memorder, [](auto lhs, auto rhs) { return rhs; });
}
[[gnu::used]] bool __atomic_compare_exchange_8(volatile void *ptr,
                                               void *expected,
                                               uint64_t desired,
                                               bool weak,
                                               int success_memorder,
...
[[gnu::used]] uint64_t __atomic_fetch_add_8(volatile void *ptr,
                                            uint64_t val,
                                            int memorder) {
  return deri::atomic_fetch_op(ptr, val, memorder, std::plus());
}
[[gnu::used]] uint64_t __atomic_fetch_sub_8(volatile void *ptr,
                                            uint64_t val,
                                            int memorder) {
  return deri::atomic_fetch_op(ptr, val, memorder, std::minus());
}
[[gnu::used]] uint64_t __atomic_fetch_and_8(volatile void *ptr,
                                            uint64_t val,
                                            int memorder) {
  return deri::atomic_fetch_op(ptr, val, memorder, std::bit_and());
}
[[gnu::used]] uint64_t __atomic_fetch_xor_8(volatile void *ptr,
                                            uint64_t val,
                                            int memorder) {
  return deri::atomic_fetch_op(ptr, val, memorder, std::bit_xor());
}
[[gnu::used]] uint64_t __atomic_fetch_or_8(volatile void *ptr,
                                           uint64_t val,
                                           int memorder) {
  return deri::atomic_fetch_op(ptr, val, memorder, std::bit_or());
}
[[gnu::used]] uint64_t __atomic_fetch_nand_8(volatile void *ptr,
                                             uint64_t val,
                                             int memorder) {
  return deri::atomic_fetch_op(
...
[[gnu::used]] void __atomic_load_c(size_t size,
                                   const void *src,
                                   void *dest,
                                   int /*memorder*/) {
...
[[gnu::used]] void __atomic_store_c(size_t size,
                                    void *dest,
                                    const void *src,
                                    int /*memorder*/) {
  deri::arch::CriticalSection cs;
...
[[gnu::used]] void __atomic_exchange_c(
...
[[gnu::used]] bool __atomic_compare_exchange_c(size_t size,
                                               void *ptr,
                                               void *expected,
                                               void *desired,
                                               bool /*weak*/,
